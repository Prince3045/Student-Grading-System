...
class studentClass:
    def __init__(self, root):
        ...
        # ==== Widgets ====
        #======column1=======
        lb_roll = Label(self.root, text=" Roll No.", font=("goudy old style", 15, 'bold'), bg='white')
        lb_roll.place(x=10, y=60)

        lb_Name = Label(self.root, text="Name", font=("goudy old style", 15, 'bold'), bg='white')
        lb_Name.place(x=10, y=100)

        lb_Email = Label(self.root, text="E-mail", font=("goudy old style", 15, 'bold'), bg='white')
        lb_Email.place(x=10, y=140)

        lb_gender = Label(self.root, text="Gender", font=("goudy old style", 15, 'bold'), bg='white')
        lb_gender.place(x=10, y=180)

        lb_state = Label(self.root, text="State", font=("goudy old style", 15, 'bold'), bg='white').place(x=10, y=220)
        ...
        lb_city = Label(self.root, text="City", font=("goudy old style", 15, 'bold'), bg='white').place(x=310, y=220)
        ...
        lb_pin = Label(self.root, text="Pin", font=("goudy old style", 15, 'bold'), bg='white').place(x=500, y=220)
        ...
        lb_address = Label(self.root, text="Address", font=("goudy old style", 15, 'bold'), bg='white')
        lb_address.place(x=10, y=260)
        ...
        #=========column2==========
        lb_dob = Label(self.root, text=" D.O.B", font=("goudy old style", 15, 'bold'), bg='white')
        lb_dob.place(x=360, y=60)

        lb_Contact = Label(self.root, text="Contact", font=("goudy old style", 15, 'bold'), bg='white')
        lb_Contact.place(x=360, y=100)

        lb_addmission = Label(self.root, text="Addmission", font=("goudy old style", 15, 'bold'), bg='white')
        lb_addmission.place(x=360, y=140)

        lb_Course = Label(self.root, text="Course", font=("goudy old style", 15, 'bold'), bg='white')
        lb_Course.place(x=360, y=180)
        ...
        self.txt_course = ttk.Combobox(self.root,textvariable=self.var_course,values=self.course_list, font=("goudy old style", 15, 'bold'))
...
#==================================================
    ...
    def search(self):
        ...
        cur=con.cursor()
        try:
            cur.execute("select * from student where roll=?", (self.var_search.get(),))  # <-- COMMA is required!
            row=cur.fetchone()
            if row!=None:
                self.CourseTable.delete(*self.CourseTable.get_children())
                self.CourseTable.insert('',END,values=row)
